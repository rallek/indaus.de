...
namespace RK\ReferenceModule\Form\Type\Finder\Base;
...
/**
 * Attached image finder form type base class.
 */
abstract class AbstractAttachedImageFinderType extends AbstractType
{
    use TranslatorTrait;

    /**
     * AttachedImageFinderType constructor.
     *
    ...
    public function addPasteAsField(FormBuilderInterface $builder, array $options)
    {
        $builder->add('pasteAs', 'Symfony\Component\Form\Extension\Core\Type\ChoiceType', [
            ...
            'empty_data' => 1,
            'choices' => [
                $this->__('Relative link to the attached image') => 1,
                $this->__('Absolute url to the attached image') => 2,
                $this->__('ID of attached image') => 3,
                $this->__('Relative link to the image') => 6,
                $this->__('Image') => 7,
                $this->__('Image with relative link to the attached image') => 8,
                $this->__('Image with absolute url to the attached image') => 9
            ],
    ...
    {
        return 'rkreferencemodule_attachedimagefinder';
    }
