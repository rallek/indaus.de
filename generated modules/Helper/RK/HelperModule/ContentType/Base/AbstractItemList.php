...
abstract class AbstractItemList extends \Content_AbstractContentType implements ContainerAwareInterface
{
    ...
    {
        $repository = $this->container->get('rk_helper_module.entity_factory')->getRepository($objectType);
        ...
        return $this->container->get('twig')->render('@RKHelperModule/' . $template, $templateParameters);
    }
