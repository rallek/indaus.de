...
namespace RK\ReferenceModule\Form\Handler\AttachedImage\Base;
...
abstract class AbstractEditHandler extends EditHandler
{
    ...
    {
        $this->objectType = 'attachedImage';
        $this->objectTypeCapital = 'AttachedImage';
        $this->objectTypeLower = 'attachedimage';
        ...
        if ($this->templateParameters['mode'] == 'create') {
            if (!$this->modelHelper->canBeCreated($this->objectType)) {
                $this->request->getSession()->getFlashBag()->add('error', $this->__('Sorry, but you can not create the attached image yet as other items are required which must be created before!'));
    ...
    protected function createForm()
    {
        ...
        return $this->formFactory->create('RK\ReferenceModule\Form\Type\AttachedImageType', $this->entityRef, $options);
    }
    ...
    protected function getRedirectCodes()
    {
        ...
        // user index page of attached image area
        $codes[] = 'userIndex';
        // admin index page of attached image area
        $codes[] = 'adminIndex';
        ...
        $codes[] = 'adminOwnView';
        // user detail page of treated attached image
        $codes[] = 'userDisplay';
        // admin detail page of treated attached image
        $codes[] = 'adminDisplay';
    ...
    protected function getDefaultReturnUrl($args)
    {
        ...
        // redirect to the list of attachedImages
        $viewArgs = [];
    ...
    protected function getDefaultMessage($args, $success = false)
    {
        ...
        switch ($args['commandName']) {
            case 'submit':
                if ($this->templateParameters['mode'] == 'create') {
                    $message = $this->__('Done! Attached image created.');
                } else {
                    $message = $this->__('Done! Attached image updated.');
                }
                break;
            case 'delete':
                $message = $this->__('Done! Attached image deleted.');
                break;
            default:
                $message = $this->__('Done! Attached image updated.');
                break;
    ...
    public function applyAction(array $args = [])
    {
        ...
        try {
            ...
            $logArgs = ['app' => 'RKReferenceModule', 'user' => $this->currentUserApi->get('uname'), 'entity' => 'attached image', 'id' => $entity->createCompositeIdentifier(), 'errorMessage' => $e->getMessage()];
