...
namespace RK\ReferenceModule\Listener;

use RK\ReferenceModule\Listener\Base\AbstractKernelListener;
...
class KernelListener extends AbstractKernelListener
{
    ...
    public function onRequest(GetResponseEvent $event)
    {
        ...
        // $testMessage = 'Hello from reference app';
        // $event->getRequest()->attributes->set('RKReferenceModule_test', $testMessage);
    ...
    public function onResponse(FilterResponseEvent $event)
    {
        ...
        // $testMessage = $event->getRequest()->attributes->get('RKReferenceModule_test');
        // now $testMessage should be: 'Hello from reference app'
    ...
    public function onException(GetResponseForExceptionEvent $event)
    {
        ...
        //     || $exception instanceof MySpecialExceptionInterface) {
            ...
            // $message = sprintf(
            //     'reference App Error says: %s with code: %s',
