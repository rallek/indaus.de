...
/**
 * Activity finder form type base class.
 */
abstract class AbstractActivityFinderType extends AbstractType
{
    use TranslatorTrait;

    /**
     * ActivityFinderType constructor.
     *
    ...
    public function addImageFields(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder->add('imageField', 'Symfony\Component\Form\Extension\Core\Type\ChoiceType', [
            ...
            'choices' => [
                ...
                $this->__('Reference image') => 'referenceImage'
            ],
    ...
    public function addPasteAsField(FormBuilderInterface $builder, array $options)
    {
        $builder->add('pasteAs', 'Symfony\Component\Form\Extension\Core\Type\ChoiceType', [
            ...
            'empty_data' => 1,
            'choices' => [
                $this->__('Relative link to the activity') => 1,
                $this->__('Absolute url to the activity') => 2,
                $this->__('ID of activity') => 3,
                $this->__('Relative link to the image') => 6,
                $this->__('Image') => 7,
                $this->__('Image with relative link to the activity') => 8,
                $this->__('Image with absolute url to the activity') => 9
            ],
            'choices_as_values' => true,
            'multiple' => false,
            'expanded' => false
    ...
    {
        return 'rkreferencemodule_activityfinder';
    }
