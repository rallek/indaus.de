...
abstract class AbstractThirdPartyListener implements EventSubscriberInterface
{
    ...
    public function contentGetTypes(\Zikula_Event $event)
    {
        ...
        $types->add('RKReferenceModule_ContentType_Item');
        
        // plugin for showing a list of multiple items
        $types->add('RKReferenceModule_ContentType_ItemList');
    }
     ...
     * RKReferenceModule will use this to add a javascript helper to add custom items.
     *
     * @param \Zikula_Event $event The event instance
     */
    public function getEditorHelpers(\Zikula_Event $event)
    {
        ...
        $helpers->add(
            [
                'module' => 'RKReferenceModule',
                'type'   => 'javascript',
                'path'   => 'modules/RK/ReferenceModule/Resources/public/js/RKReferenceModule.Finder.js'
            ]
        );
    }
    ...
    public function getTinyMcePlugins(\Zikula_Event $event)
    {
        ...
        $plugins->add(
            [
                'name' => 'rkreferencemodule',
                'path' => 'modules/RK/ReferenceModule/Resources/docs/scribite/plugins/TinyMce/vendor/tinymce/plugins/rkreferencemodule/plugin.js'
            ]
        );
    }
    ...
    public function getCKEditorPlugins(\Zikula_Event $event)
    {
        ...
        $plugins->add(
            [
                'name' => 'rkreferencemodule',
                'path' => 'modules/RK/ReferenceModule/Resources/docs/scribite/plugins/CKEditor/vendor/ckeditor/plugins/rkreferencemodule/',
                'file' => 'plugin.js',
                'img'  => 'ed_rkreferencemodule.gif'
            ]
        );
    }
}
