...
namespace RK\InfoModule\Form\Type\QuickNavigation\Base;
...
/**
 * Information quick navigation form type base class.
 */
abstract class AbstractInformationQuickNavType extends AbstractType
{
    use TranslatorTrait;
    ...
    /**
     * InformationQuickNavType constructor.
     *
    ...
    {
        $listEntries = $this->listHelper->getEntries('information', 'workflowState');
        $choices = [];
        $choiceAttributes = [];
    ...
    {
        return 'rkinfomodule_informationquicknav';
    }
}
