...
namespace RK\ReferenceModule\ContentType\Base;
...
abstract class AbstractItemList extends \Content_AbstractContentType implements ContainerAwareInterface
{
    ...
    {
        return $this->container->get('translator.default')->__('RKReferenceModule list view');
    }
    ...
    {
        return $this->container->get('translator.default')->__('Display list of RKReferenceModule objects.');
    }
    ...
    {
        $repository = $this->container->get('rk_reference_module.entity_factory')->getRepository($this->objectType);
        ...
        $imageHelper = $this->container->get('rk_reference_module.image_helper');
    ...
    protected function getDisplayTemplate()
    {
        ...
        foreach ($templateOptions as $templatePath) {
            if ($templating->exists('@RKReferenceModule/' . $templatePath)) {
                $template = '@RKReferenceModule/' . $templatePath;
                break;
            }
        }
    ...
    protected function getSortParam($repository)
    {
        ...
        if ($this->sorting == 'newest') {
            $selectionHelper = $this->container->get('rk_reference_module.selection_helper');
    ...
    public function startEditing()
    {
        ...
        $this->view->toplevelmodule = 'RKReferenceModule';
    
        // ensure our custom plugins are loaded
        array_push($this->view->plugins_dir, 'modules/RK/ReferenceModule/Resources/views/plugins');
    }
