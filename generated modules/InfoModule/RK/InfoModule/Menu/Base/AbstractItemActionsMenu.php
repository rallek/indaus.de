...
namespace RK\InfoModule\Menu\Base;
...
class AbstractItemActionsMenu implements ContainerAwareInterface
{
    ...
    public function menu(FactoryInterface $factory, array $options)
    {
        ...
        if ($entity instanceof InformationEntity) {
            $component = 'RKInfoModule:Information:';
            $instance = $entity['id'] . '::';
            $routePrefix = 'rkinfomodule_information_';
            ...
            if ($permissionApi->hasPermission($component, $instance, ACCESS_EDIT)) {
                ...
                $menu[$this->__('Edit')]->setLinkAttribute('title', $this->__('Edit this information'));
                $menu->addChild($this->__('Reuse'), [
                    'route' => $routePrefix . $routeArea . 'edit',
                    'routeParameters' => ['astemplate' => $entity['id']]
                ])->setAttribute('icon', 'fa fa-files-o');
                $menu[$this->__('Reuse')]->setLinkAttribute('title', $this->__('Reuse for new information'));
            }
            if ($context == 'display') {
