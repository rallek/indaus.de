...
abstract class AbstractThirdPartyListener implements EventSubscriberInterface
{
    ...
    public function contentGetTypes(\Zikula_Event $event)
    {
        ...
        $types->add('RKInfoModule_ContentType_Item');
        
        // plugin for showing a list of multiple items
        $types->add('RKInfoModule_ContentType_ItemList');
    }
     ...
     * RKInfoModule will use this to add a javascript helper to add custom items.
     *
     * @param \Zikula_Event $event The event instance
     */
    public function getEditorHelpers(\Zikula_Event $event)
    {
        ...
        $helpers->add(
            [
                'module' => 'RKInfoModule',
                'type'   => 'javascript',
                'path'   => 'modules/RK/InfoModule/Resources/public/js/RKInfoModule.Finder.js'
            ]
        );
    }
    ...
    public function getTinyMcePlugins(\Zikula_Event $event)
    {
        ...
        $plugins->add(
            [
                'name' => 'rkinfomodule',
                'path' => 'modules/RK/InfoModule/Resources/docs/scribite/plugins/TinyMce/vendor/tinymce/plugins/rkinfomodule/plugin.js'
            ]
        );
    }
    ...
    public function getCKEditorPlugins(\Zikula_Event $event)
    {
        ...
        $plugins->add(
            [
                'name' => 'rkinfomodule',
                'path' => 'modules/RK/InfoModule/Resources/docs/scribite/plugins/CKEditor/vendor/ckeditor/plugins/rkinfomodule/',
                'file' => 'plugin.js',
                'img'  => 'ed_rkinfomodule.gif'
            ]
        );
    }
}
