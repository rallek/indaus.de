...
<div style="margin-left: 80px">
    <div class="form-group">
        {formlabel for='rKReferenceModuleObjectType' __text='Object type' cssClass='col-sm-3 control-label'}
        <div class="col-sm-9">
    ...
    <div{* class="form-group"*}>
        ...
        {rkreferencemoduleItemSelector id='id' group='data' objectType=$objectType}
    </div>
