...
namespace RK\InfoModule\Block\Base;
...
abstract class AbstractItemListBlock extends AbstractBlockHandler
{
    ...
    public function display(array $properties)
    {
        ...
        if (!$this->hasPermission('RKInfoModule:ItemListBlock:', "$properties[title]::", ACCESS_OVERVIEW)) {
            return false;
        }
        ...
        if (empty($properties['title'])) {
            $properties['title'] = $this->__('RKInfoModule items');
        }
    ...
    protected function getDisplayTemplate(array $properties)
    {
        ...
        foreach ($templateOptions as $templatePath) {
            if ($templating->exists('@RKInfoModule/' . $templatePath)) {
                $template = '@RKInfoModule/' . $templatePath;
                break;
            }
        }
    ...
    {
        return 'RK\InfoModule\Block\Form\Type\ItemListBlockType';
    }
    ...
    {
        return '@RKInfoModule/Block/itemlist_modify.html.twig';
    }
