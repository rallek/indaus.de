...
namespace RK\ReferenceModule\Entity\Factory\Base;
 ...
 */
abstract class AbstractReferenceFactory
{
    /**
    ...
    {
        $entityClass = 'RK\\ReferenceModule\\Entity\\' . ucfirst($objectType) . 'Entity';

        return $this->objectManager->getRepository($entityClass);
    }

    /**
     * Creates a new attachedImage instance.
     *
     * @return RK\ReferenceModule\Entity\attachedImageEntity The newly created entity instance
     */
     ...
     *
     * @return RK\ReferenceModule\Entity\activityEntity The newly created entity instance
     */
