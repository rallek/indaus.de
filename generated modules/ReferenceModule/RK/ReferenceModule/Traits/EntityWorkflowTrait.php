...
namespace RK\ReferenceModule\Traits;
...
trait EntityWorkflowTrait
{
    ...
    {
        $entityClass = 'RKReferenceModule:' . ucfirst($this->get_objectType()) . 'Entity';
    ...
    public function initWorkflow($forceLoading = false)
    {
        ...
        $workflowHelper = $serviceManager->get('rk_reference_module.workflow_helper');
        ...
        if (($loadingRequired && !$isReuse) || $forceLoading) {
            $result = Zikula_Workflow_Util::getWorkflowForObject($this, $objectType, $idColumn, 'RKReferenceModule');
            if (!$result) {
    ...
    public function resetWorkflow()
    {
        ...
        $workflowHelper = ServiceUtil::get('rk_reference_module.workflow_helper');
