...
namespace RK\InfoModule\ContentType\Base;
...
abstract class AbstractItemList extends \Content_AbstractContentType implements ContainerAwareInterface
{
    ...
    {
        return $this->container->get('translator.default')->__('RKInfoModule list view');
    }
    ...
    {
        return $this->container->get('translator.default')->__('Display list of RKInfoModule objects.');
    }
    ...
    public function display()
    {
        ...
        return $this->container->get('twig')->render('@RKInfoModule/' . $template, $templateParameters);
    }
    ...
    public function startEditing()
    {
        ...
        $this->view->toplevelmodule = 'RKInfoModule';
    
        // ensure our custom plugins are loaded
        array_push($this->view->plugins_dir, 'modules/RK/InfoModule/Resources/views//plugins');
    }
