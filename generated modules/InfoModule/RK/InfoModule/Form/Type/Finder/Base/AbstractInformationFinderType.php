...
namespace RK\InfoModule\Form\Type\Finder\Base;
...
/**
 * Information finder form type base class.
 */
abstract class AbstractInformationFinderType extends AbstractType
{
    use TranslatorTrait;
    ...
    /**
     * InformationFinderType constructor.
     *
    ...
    public function addPasteAsField(FormBuilderInterface $builder, array $options)
    {
        $builder->add('pasteAs', 'Symfony\Component\Form\Extension\Core\Type\ChoiceType', [
            ...
            'empty_data' => 1,
            'choices' => [
                $this->__('Link to the information') => 1,
                $this->__('ID of information') => 2
            ],
    ...
    {
        return 'rkinfomodule_informationfinder';
    }
