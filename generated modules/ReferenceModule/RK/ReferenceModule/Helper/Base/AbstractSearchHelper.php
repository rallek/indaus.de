...
abstract class AbstractSearchHelper extends AbstractSearchable
{
    ...
    public function getOptions($active, $modVars = null)
    {
        ...
        $searchTypes = array('attachedImage', 'activity');
        ...
        return $this->getContainer()->get('twig')->render('@RKReferenceModule/Search/options.html.twig', $templateParameters);
    }
    ...
    public function getResults(array $words, $searchType = 'AND', $modVars = null)
    {
        ...
        if (!is_array($searchTypes) || !count($searchTypes)) {
            if ($request->isMethod('GET')) {
                $searchTypes = $request->query->get('rKReferenceModuleSearchTypes', []);
            } elseif ($request->isMethod('POST')) {
                $searchTypes = $request->request->get('rKReferenceModuleSearchTypes', []);
            }
        }
    
        $controllerHelper = $this->container->get('rk_reference_module.controller_helper');
        ...
        foreach ($searchTypes as $objectType) {
            ...
            $repository = $this->container->get('rk_reference_module.entity_factory')->getRepository($objectType);
