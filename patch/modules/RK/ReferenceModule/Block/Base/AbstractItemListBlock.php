...
namespace RK\ReferenceModule\Block\Base;
...
abstract class AbstractItemListBlock extends AbstractBlockHandler
{
    ...
    public function display(array $properties)
    {
        ...
        if (!$this->hasPermission('RKReferenceModule:ItemListBlock:', "$properties[title]::", ACCESS_OVERVIEW)) {
            return false;
        }
        ...
        if (empty($properties['title'])) {
            $properties['title'] = $this->__('RKReferenceModule items');
        }
    ...
    {
        return 'RK\ReferenceModule\Block\Form\Type\ItemListBlockType';
    }
    ...
    {
        return '@RKReferenceModule/Block/itemlist_modify.html.twig';
    }
