 ...
 */
function RKReferenceModule_operation_delete(&$entity, $params)
{
    ...
    $logArgs = ['app' => 'RKReferenceModule', 'user' => $serviceManager->get('zikula_users_module.current_user')->get('uname')];
