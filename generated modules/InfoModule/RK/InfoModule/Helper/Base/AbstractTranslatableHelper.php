...
abstract class AbstractTranslatableHelper
{
     ...
     */
    public function __construct(TranslatorInterface $translator, RequestStack $requestStack, VariableApi $variableApi, InfoFactory $entityFactory)
    {
        ...
        switch ($objectType) {
            case 'information':
                $fields = [
                    [
                        'name' => 'title',
                        'default' => $this->translator->__('Title')
                    ],[
                        'name' => 'theDescription',
                        'default' => $this->translator->__('The description')
                    ]
                ];
                break;
        }
