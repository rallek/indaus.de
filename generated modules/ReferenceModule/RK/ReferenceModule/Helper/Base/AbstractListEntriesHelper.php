...
abstract class AbstractListEntriesHelper
{
    ...
    public function getEntries($objectType, $fieldName)
    {
        ...
        switch ($objectType) {
            case 'attachedImage':
                switch ($fieldName) {
                    case 'workflowState':
                        $entries = $this->getWorkflowStateEntriesForAttachedImage();
                        break;
                }
                break;
            case 'activity':
                switch ($fieldName) {
                    case 'workflowState':
                        $entries = $this->getWorkflowStateEntriesForActivity();
                        break;
                }
                break;
        }
     ...
     * @return array Array with desired list entries
     */
    public function getWorkflowStateEntriesForAttachedImage()
    {
        $states = [];
        $states[] = [
            'value'   => 'approved',
     ...
     * @return array Array with desired list entries
     */
    public function getWorkflowStateEntriesForActivity()
    {
        $states = [];
        $states[] = [
            'value'   => 'approved',
