...
namespace RK\ReferenceModule\Form\Plugin\Base;
...
class AbstractItemSelector extends Zikula_Form_Plugin_TextInput implements ContainerAwareInterface
{
    ...
    public function render(Zikula_Form_View $view)
    {
        ...
        if ($firstTime) {
            ...
            $jsAssetBag->add($assetHelper->resolve('@RKReferenceModule:js/RKReferenceModule.js'));
            $jsAssetBag->add($assetHelper->resolve('@RKReferenceModule:js/RKReferenceModule.Finder.js'));
        ...
        if (!$permissionApi->hasPermission('RKReferenceModule:' . ucfirst($this->objectType) . ':', '::', ACCESS_COMMENT)) {
            return false;
        }
        ...
        $view = Zikula_View::getInstance('RKReferenceModule', false);
    ...
    public function decode(Zikula_Form_View $view)
    {
        ...
        $this->objectType = $request->request->get('RKReferenceModule_objecttype', 'activity');
