    ...
    public function getCustomRuntimeOptions($objectType = '', $fieldName = '', $contextName = '', $context = '', $args = [])
    {
        $options = [
            'thumbnail' => [
                ...
                'mode'      => $this->variableApi->get('RKReferenceModule', 'thumbnailMode' . ucfirst($objectType) . ucfirst($fieldName), 'inset'),
        ...
        if ($contextName == $this->name . '_ajax_autocomplete') {
            ...
            if (in_array($args['action'], ['view', 'display', 'edit'])) {
                ...
                $options['thumbnail']['size'] = [
                    $this->variableApi->get('RKReferenceModule', 'thumbnailWidth' . $fieldSuffix, $defaultWidth),
                    $this->variableApi->get('RKReferenceModule', 'thumbnailHeight' . $fieldSuffix, $defaultHeight)
                ];
            }
        }
