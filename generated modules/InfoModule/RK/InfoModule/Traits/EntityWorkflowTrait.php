...
namespace RK\InfoModule\Traits;
...
trait EntityWorkflowTrait
{
    ...
    {
        $entityClass = 'RKInfoModule:' . ucfirst($this->get_objectType()) . 'Entity';
    ...
    public function initWorkflow($forceLoading = false)
    {
        ...
        $workflowHelper = $serviceManager->get('rk_info_module.workflow_helper');
        ...
        if (($loadingRequired && !$isReuse) || $forceLoading) {
            $result = Zikula_Workflow_Util::getWorkflowForObject($this, $objectType, $idColumn, 'RKInfoModule');
            if (!$result) {
    ...
    public function resetWorkflow()
    {
        ...
        $workflowHelper = ServiceUtil::get('rk_info_module.workflow_helper');
