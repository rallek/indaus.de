...
abstract class AbstractAppSettingsType extends AbstractType
{
    ...
    public function addListViewsFields(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('linkOwnLinkersOnAccountPage', 'Symfony\Component\Form\Extension\Core\Type\CheckboxType', [
                'label' => $this->__('Link own linkers on account page') . ':',
                'label_attr' => [
                    'class' => 'tooltips',
                    'title' => $this->__('Whether to add a link to linkers of the current user on his account page')
                ],
                'help' => $this->__('Whether to add a link to linkers of the current user on his account page'),
                'required' => false,
                'data' => (bool)(isset($this->modVars['linkOwnLinkersOnAccountPage']) ? $this->modVars['linkOwnLinkersOnAccountPage'] : true),
                'attr' => [
                    'title' => $this->__('The link own linkers on account page option.')
                ],
            ])
            ...
            ->add('linkOwnCarouselItemsOnAccountPage', 'Symfony\Component\Form\Extension\Core\Type\CheckboxType', [
                'label' => $this->__('Link own carousel items on account page') . ':',
                'label_attr' => [
                    'class' => 'tooltips',
                    'title' => $this->__('Whether to add a link to carousel items of the current user on his account page')
                ],
                'help' => $this->__('Whether to add a link to carousel items of the current user on his account page'),
                'required' => false,
                'data' => (bool)(isset($this->modVars['linkOwnCarouselItemsOnAccountPage']) ? $this->modVars['linkOwnCarouselItemsOnAccountPage'] : true),
                'attr' => [
                    'title' => $this->__('The link own carousel items on account page option.')
                ],
            ])
            ...
            ->add('linkOwnCarousellsOnAccountPage', 'Symfony\Component\Form\Extension\Core\Type\CheckboxType', [
                'label' => $this->__('Link own carousells on account page') . ':',
                'label_attr' => [
                    'class' => 'tooltips',
                    'title' => $this->__('Whether to add a link to carousells of the current user on his account page')
                ],
                'help' => $this->__('Whether to add a link to carousells of the current user on his account page'),
                'required' => false,
                'data' => (bool)(isset($this->modVars['linkOwnCarousellsOnAccountPage']) ? $this->modVars['linkOwnCarousellsOnAccountPage'] : true),
                'attr' => [
                    'title' => $this->__('The link own carousells on account page option.')
                ],
            ])
            ...
            ->add('linkOwnInfosOnAccountPage', 'Symfony\Component\Form\Extension\Core\Type\CheckboxType', [
                'label' => $this->__('Link own infos on account page') . ':',
                'label_attr' => [
                    'class' => 'tooltips',
                    'title' => $this->__('Whether to add a link to infos of the current user on his account page')
                ],
                'help' => $this->__('Whether to add a link to infos of the current user on his account page'),
                'required' => false,
                'data' => (bool)(isset($this->modVars['linkOwnInfosOnAccountPage']) ? $this->modVars['linkOwnInfosOnAccountPage'] : true),
                'attr' => [
                    'title' => $this->__('The link own infos on account page option.')
                ],
            ])
        ;
    }
