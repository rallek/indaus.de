...
abstract class AbstractInfoType extends AbstractType
{
     ...
     */
    public function __construct(TranslatorInterface $translator, HelperFactory $entityFactory, VariableApi $variableApi, TranslatableHelper $translatableHelper, ListEntriesHelper $listHelper, FeatureActivationHelper $featureActivationHelper)
    {
        ...
        if ($this->variableApi->getSystemVar('multilingual') && $this->featureActivationHelper->isEnabled(FeatureActivationHelper::TRANSLATIONS, 'info')) {
            ...
            if (is_array($supportedLanguages) && count($supportedLanguages) > 1) {
                ...
                foreach ($supportedLanguages as $language) {
                    ...
                    $builder->add('infoTitle' . $language, 'Symfony\Component\Form\Extension\Core\Type\TextType', [
                        'label' => $this->__('Info title') . ':',
                        'data' => isset($translationData['infoTitle' . $language]) ? $translationData['infoTitle' . $language] : null,
                        'empty_data' => '',
                        'mapped' => false,
                        'attr' => [
                            'maxlength' => 255,
                    ...
                    $builder->add('infoDescription' . $language, 'Symfony\Component\Form\Extension\Core\Type\TextareaType', [
                        'label' => $this->__('Info description') . ':',
                        'data' => isset($translationData['infoDescription' . $language]) ? $translationData['infoDescription' . $language] : null,
                        'empty_data' => '',
                        'mapped' => false,
                        'attr' => [
                            'maxlength' => 2000,
