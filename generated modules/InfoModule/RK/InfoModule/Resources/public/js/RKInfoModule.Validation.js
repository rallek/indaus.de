...
function rKInfoReadDate(val, includeTime)
{
...
function rKInfoValidateNoSpace(val)
{
    var valStr;
 ...
 */
function rKInfoExecuteCustomValidationConstraints(objectType, currentEntityId)
{
    jQuery('.validate-nospace').each( function() {
        if (!rKInfoValidateNoSpace(jQuery(this).val())) {
