...
abstract class AbstractExternalController extends AbstractController
{
    ...
    public function displayAction($objectType, $id, $source, $displayMode)
    {
        ...
        $templateParameters['featureActivationHelper'] = $this->get('rk_info_module.feature_activation_helper');
        
        return $this->render('@RKInfoModule/External/' . ucfirst($objectType) . '/display.html.twig', $templateParameters);
    }
    ...
    public function finderAction(Request $request, $objectType, $editor, $sort, $sortdir, $pos = 1, $num = 0)
    {
        ...
        $cssAssetBag->add($assetHelper->resolve('@RKInfoModule:css/style.css'));
        ...
        if (!$this->hasPermission('RKInfoModule:' . ucfirst($objectType) . ':', '::', ACCESS_COMMENT)) {
        ...
        $form = $this->createForm('RK\InfoModule\Form\Type\Finder\\' . ucfirst($objectType) . 'FinderType', $templateParameters, $formOptions);
        ...
        $output = $this->renderView('@RKInfoModule/External/' . ucfirst($objectType) . '/find.html.twig', $templateParameters);
