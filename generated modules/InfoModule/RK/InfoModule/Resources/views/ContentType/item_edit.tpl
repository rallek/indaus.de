...
<div style="margin-left: 80px">
    <div class="form-group">
        {formlabel for='rKInfoModuleObjectType' __text='Object type' cssClass='col-sm-3 control-label'}
        <div class="col-sm-9">
            {rkinfomoduleObjectTypeSelector assign='allObjectTypes'}
            {formdropdownlist id='rKInfoModuleObjectType' dataField='objectType' group='data' mandatory=true items=$allObjectTypes cssClass='form-control'}
    ...
    <div{* class="form-group"*}>
        ...
        {rkinfomoduleItemSelector id='id' group='data' objectType=$objectType}
    </div>
