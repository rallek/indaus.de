...
abstract class AbstractWorkflowHelper
{
    ...
    public function executeAction($entity, $actionId = '', $recursive = false)
    {
        ...
        $result = Zikula_Workflow_Util::executeAction($schemaName, $entity, $actionId, $objectType, 'RKInfoModule', $idColumn);
