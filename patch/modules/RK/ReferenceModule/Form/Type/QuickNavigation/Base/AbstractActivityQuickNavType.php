...
/**
 * Activity quick navigation form type base class.
 */
abstract class AbstractActivityQuickNavType extends AbstractType
{
    use TranslatorTrait;
    ...
    /**
     * ActivityQuickNavType constructor.
     *
    ...
    * @param RequestStack        $requestStack RequestStack service instance
     ...
     */
    public function __construct(TranslatorInterface $translator, RequestStack $requestStack, ListEntriesHelper $listHelper, LocaleApi $localeApi)
    {
    ...
    {
        $listEntries = $this->listHelper->getEntries('activity', 'workflowState');
        $choices = [];
        $choiceAttributes = [];
    ...
    {
        return 'rkreferencemodule_activityquicknav';
    }
}
