...
abstract class AbstractUserListener implements EventSubscriberInterface
{
     ...
     * @return void
     */
    public function __construct(TranslatorInterface $translator, InfoFactory $entityFactory, CurrentUserApi $currentUserApi, LoggerInterface $logger)
    {
    ...
    public function delete(GenericEvent $event)
    {
        ...
        $repo = $this->entityFactory->getRepository('information');
        // set creator to admin (2) for all informations created by this user
        $repo->updateCreator($userId, 2, $this->translator, $this->logger, $this->currentUserApi);
        
        // set last editor to admin (2) for all informations updated by this user
        $repo->updateLastEditor($userId, 2, $this->translator, $this->logger, $this->currentUserApi);
        
        $logArgs = ['app' => 'RKInfoModule', 'user' => $this->currentUserApi->get('uname'), 'entities' => 'informations'];
