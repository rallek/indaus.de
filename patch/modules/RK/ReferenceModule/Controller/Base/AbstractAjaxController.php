...
abstract class AbstractAjaxController extends AbstractController
{
    ...
    {
        if (!$this->hasPermission('RKReferenceModule::Ajax', '::', ACCESS_EDIT)) {
            return true;
        }
    ...
    public function getItemListFinderAction(Request $request)
    {
        ...
        $objectType = $request->request->getAlnum('ot', 'activity');
    ...
    protected function prepareSlimItem($repository, $objectType, $item, $itemId, $descriptionField)
    {
        ...
        $previewInfo = base64_encode($this->get('twig')->render('@RKReferenceModule/External/' . ucfirst($objectType) . '/info.html.twig', $previewParameters));
